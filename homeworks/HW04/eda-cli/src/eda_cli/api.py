...
class QualityFlagsResponse(BaseModel):
    ...
    flags: dict[str, Any] = Field(
        ...,
        description="Полный словарь флагов и метрик из compute_quality_flags",
    )
...
# ---------- Новый эндпоинт: полный набор флагов ----------
...
async def quality_flags_from_csv(
    ...
    """
    Эндпоинт, который принимает CSV-файл, использует EDA-ядро
    (summarize_dataset + missing_table + compute_quality_flags)
    и возвращает **полный** словарь флагов/метрик качества.
    """
